...
const ThirdPersonalizationScreen: React.FC<props> = ({navigation}) => {
    ...
    <>
      ...
      <View style={styles.container}>
        ...
        <View>
          <Button
            small
            onPress={() => navigation.navigate('FourthPersonalizationScreen')}>
            Next
          </Button>
          <Divider />
          <TextField center>3 / 4</TextField>
          <Divider medium />
          <TextField
            medium
            color="blue"
...
export {ThirdPersonalizationScreen};
